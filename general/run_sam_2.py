  ...
  for idx_eta in range(len(etas)):
    ...
    for idx_rho in tqdm(range(len(rhos))):
      ...
      results={'error_mean_SGD_SGD_SDE':error_mean_SGD_SGD_SDE,'error_mean_SAM_True_SGD_SDE':error_mean_SAM_True_SGD_SDE,
              'error_mean_SAM_True_SAM_True_SDE':error_mean_SAM_True_SAM_True_SDE, 'error_mean_SAM_True_SAM_True_SDE':error_mean_SAM_True_SAM_True_SDE,
              'error_mean_SAM_True_SAM_SDE':error_mean_SAM_True_SAM_SDE,'error_mean_SAM_True_USAM_SDE':error_mean_SAM_True_USAM_SDE,
              'error_mean_SAM_SGD_SDE':error_mean_SAM_SGD_SDE,'error_mean_SAM_SAM_SDE':error_mean_SAM_SAM_SDE,
              'error_mean_USAM_USAM_SDE':error_mean_USAM_USAM_SDE,'error_mean_USAM_SGD_SDE':error_mean_USAM_SGD_SDE,
              'error_mean_USAM_USAM_SDE_DRIFT':error_mean_USAM_USAM_SDE_DRIFT,'error_mean_SAM_SAM_SDE_DRIFT':error_mean_SAM_SAM_SDE_DRIFT,
              'error_std_SGD_SGD_SDE':error_std_SGD_SGD_SDE,'error_std_SAM_True_SGD_SDE':error_std_SAM_True_SGD_SDE,
              'error_mean_SAM_True_SAM_True_SDE_DRIFT':error_mean_SAM_True_SAM_True_SDE_DRIFT,
              'error_std_SAM_True_SAM_True_SDE':error_std_SAM_True_SAM_True_SDE, 'error_std_SAM_True_SAM_True_SDE':error_std_SAM_True_SAM_True_SDE,
              'error_std_SAM_True_SAM_SDE':error_std_SAM_True_SAM_SDE,'error_std_SAM_True_USAM_SDE':error_std_SAM_True_USAM_SDE,
              'error_std_SAM_SGD_SDE':error_std_SAM_SGD_SDE,'error_std_SAM_SAM_SDE':error_std_SAM_SAM_SDE,
              'error_std_USAM_USAM_SDE':error_std_USAM_USAM_SDE,'error_std_USAM_SGD_SDE':error_std_USAM_SGD_SDE,
              'error_std_USAM_USAM_SDE_DRIFT':error_std_USAM_USAM_SDE_DRIFT,'error_std_SAM_SAM_SDE_DRIFT':error_std_SAM_SAM_SDE_DRIFT,
              'error_std_SAM_True_SAM_True_SDE_DRIFT':error_std_SAM_True_SAM_True_SDE_DRIFT,
              'loss_all_SGD':loss_all_SGD,'loss_all_SGD_SDE':loss_all_SGD_SDE,'loss_all_SAM_True':loss_all_SAM_True,
              'loss_all_SAM_True_SDE':loss_all_SAM_True_SDE,'loss_all_USAM': loss_all_USAM,
              'loss_all_USAM_SDE':loss_all_USAM_SDE,'loss_all_SAM':loss_all_SAM,
              'loss_all_SAM_SDE':loss_all_SAM_SDE,'loss_all_USAM_SDE_DRIFT':loss_all_USAM_SDE_DRIFT,
              'loss_all_SAM_SDE_DRIFT':loss_all_SAM_SDE_DRIFT,'loss_all_SAM_SDE_True_DRIFT':loss_all_SAM_SDE_True_DRIFT,
              ...
              'loss_all_USAM_std':loss_all_USAM_std,'loss_all_SAM_std':loss_all_SAM_std,
              'loss_all_SAM_SDE_std':loss_all_SAM_SDE_std,'loss_all_USAM_SDE_std':loss_all_USAM_SDE_std,
              'loss_all_USAM_SDE_DRIFT_std':loss_all_USAM_SDE_DRIFT_std,'loss_all_SAM_SDE_DRIFT_std':loss_all_SAM_SDE_DRIFT_std,
              'loss_all_SAM_SDE_True_DRIFT_std':loss_all_SAM_SDE_True_DRIFT_std,
              'x_it_all_SGD':x_it_all_SGD,'x_it_all_SGD_SDE':x_it_all_SGD_SDE,'x_it_all_SAM_True':x_it_all_SAM_True,
              'x_it_all_SAM_True_SDE':x_it_all_SAM_True_SDE,'x_it_all_USAM': x_it_all_USAM,
              'x_it_all_USAM_SDE':x_it_all_USAM_SDE,'x_it_all_SAM':x_it_all_SAM,
              'x_it_all_SAM_SDE':x_it_all_SAM_SDE,'x_it_all_USAM_SDE_DRIFT':x_it_all_USAM_SDE_DRIFT,
              'x_it_all_SAM_SDE_DRIFT':x_it_all_SAM_SDE_DRIFT,'x_it_all_SAM_SDE_True_DRIFT':x_it_all_SAM_SDE_True_DRIFT,
              ...
              'x_it_all_USAM_std':x_it_all_USAM_std,'x_it_all_SAM_std':x_it_all_SAM_std,
              'x_it_all_SAM_SDE_std':x_it_all_SAM_SDE_std,'x_it_all_USAM_SDE_std':x_it_all_USAM_SDE_std,
              'x_it_all_USAM_SDE_DRIFT_std':x_it_all_USAM_SDE_DRIFT_std,'x_it_all_SAM_SDE_DRIFT_std':x_it_all_SAM_SDE_DRIFT_std,
              'x_it_all_SAM_SDE_True_DRIFT_std':x_it_all_SAM_SDE_True_DRIFT_std,
