...
def main(cfg):
  ...
  for idx_eta in range(len(etas)):
    ...
    for idx_rho in tqdm(range(len(rhos))):
      ...
      results={'error_mean_SGD_SGD_SDE':error_mean_SGD_SGD_SDE,'error_mean_SAM_SGD_SDE':error_mean_SAM_SGD_SDE,
              ...
              'loss_all_SGD':loss_all_SGD,'loss_all_SGD_SDE':loss_all_SGD_SDE,'loss_all_SAM':loss_all_SAM,'loss_all_SAM_SDE':loss_all_SAM_SDE,
